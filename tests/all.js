...
describe('.all()', function() {
  ...
  describe('Array of Async Functions', function() {
    ...
    it('should reject if error occurs in async function', function(done) {
      let ep = am.all([
        async function() {
          return await 23864
        },
  ...
  describe('Object Async Functions', function() {
    it('should return extended promise resolving to object of returned value of async function', function(done) {
      let ep = am.all({
        a: async function() {
          return await 23864
        },
